      ...
      <section className="relative min-h-[92vh] flex items-center">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-black text-primary-foreground leading-[1.08] mb-6 uppercase tracking-tight animate-fade-in-up">TRATTORI PROFESSIONALI PER L' AGRICOLTURA MODERNA

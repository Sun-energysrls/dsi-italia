...
const colorOptions = [
  { name: "Verde", value: "hsl(160, 33%, 17%)" },
  { name: "Rosso", value: "hsl(0, 70%, 45%)" },
  { name: "Arancione", value: "hsl(36, 100%, 45%)" },
  { name: "Blu", value: "hsl(220, 60%, 40%)" },
  { name: "Nero", value: "hsl(0, 0%, 15%)" },
];
      ...
      <Layout>
        <section className="py-24 lg:py-32 bg-muted/30">
          <div className="container mx-auto px-4 text-center max-w-xl">
            ...
            <a href="/" className="gradient-accent text-accent-foreground px-8 py-3 rounded-md font-semibold uppercase tracking-wide inline-block">
              Torna alla Home
            </a>
          </div>
        </section>
    ...
    <Layout>
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          {step === "config" ? (
            <div className="bg-card rounded-lg border border-border p-6 lg:p-10 shadow-card space-y-8">
              {/* Model */}
              <div>
                <label className="block text-sm font-semibold text-foreground mb-2">Modello *</label>
                <select
                  value={model}
                ...
                <div className="flex flex-wrap gap-3">
                  {colorOptions.map((c) => (
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-md border text-sm font-medium transition-all ${color === c.name ? "border-secondary bg-secondary/10" : "border-border hover:border-secondary/50"}`}
                    >
              ...
              {/* Accessories */}
              <div>
                <label className="block text-sm font-semibold text-foreground mb-2">Accessori</label>
                <div className="flex flex-wrap gap-3">
              ...
              {/* Customer data */}
              <h3 className="font-display text-xl font-bold text-foreground">I Tuoi Dati</h3>
              ...
              <button
                ...
                disabled={!canProceed}
                className="w-full gradient-accent text-accent-foreground py-4 rounded-md text-base font-semibold uppercase tracking-wide disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
              >
            ...
            <div className="bg-card rounded-lg border border-border p-6 lg:p-10 shadow-card space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="font-display text-lg font-bold text-foreground">Dati di Contatto</h3>
                {[
                ...
                {message && <p className="text-sm text-muted-foreground mt-2">Messaggio: {message}</p>}
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <button
                  ...
                  className="flex-1 gradient-accent text-accent-foreground py-3 rounded-md font-semibold uppercase tracking-wide inline-flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
                >

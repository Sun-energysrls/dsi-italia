  ...
  return (
    ...
    >
      <video
        ...
        loop
        playsInline
        className="absolute inset-0 w-full h-full object-cover object-center scale-[1.25] origin-center lg:scale-100"
      />
      ...
      >
        <span className="text-xs uppercase tracking-[0.3em] font-medium block" style={{ paddingLeft: "0.3em" }}>
          Scorri
        </span>

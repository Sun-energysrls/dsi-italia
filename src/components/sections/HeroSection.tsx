  ...
  return (
    ...
    >
      <video
        ...
        loop
        playsInline
        className="absolute inset-0 w-full h-full object-cover object-center scale-[1.15] origin-center lg:scale-100"
      />
      ...
      >
        <span className="text-xs uppercase tracking-[0.3em] font-medium mr-[-0.3em] block">
          Scorri
        </span>

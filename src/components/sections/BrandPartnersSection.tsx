...
const brandData = [
  ...
  },
  {
    ...
    description: "Divisione agricola del gruppo Lingong (LGMG), colosso delle macchine da costruzione. Dal 2023 una gamma moderna di trattori da 90 HP fino ai modelli ibridi da circa 600 HP.",
    stats: brandStats('600', '1972'),
    color: '#1fae7a',
    locked: false,
  },
];

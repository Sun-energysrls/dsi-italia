          ...
          {categories.map((cat, i) => (
            <AnimatedSection key={cat.id} delay={i * 0.08}>
              <Link
                ...
                className="group p-8 bg-muted/30 border border-border hover:border-secondary/50 shadow-card hover:shadow-elevated transition-all duration-300 text-center block"
              >

    ...
    <footer className="gradient-primary text-primary-foreground">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Links */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4">Navigazione</h4>
          ...
          {/* Products */}
          <div>
            <h4 className="font-display text-lg font-semibold mb-4">Prodotti</h4>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-primary-foreground/70 text-sm">Via dell'Industria 42, 00100 Roma, Italia</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="h-4 w-4 text-secondary shrink-0" />
                <a href="tel:+390000000000" className="text-primary-foreground/70 hover:text-secondary transition-colors text-sm">
                  +39 000 000 0000
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-secondary shrink-0" />
                <a href="mailto:info@dsi-import.it" className="text-primary-foreground/70 hover:text-secondary transition-colors text-sm">
                  info@dsi-import.it
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-primary-foreground/50 hover:text-secondary text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-primary-foreground/50 hover:text-secondary text-sm transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
